package pe.edu.upeu.d.controller;
...
public class HomeController {
	...
	public ModelAndView hello(HttpServletRequest request, HttpServletResponse response,
		 ...
		 * if (auth.isAuthenticated()) { System.out.println("EstÃ¡ autenticado"); return
		 * "menu"; } else { System.out.println("No estÃ¡ autenticado"); return "login";
		 * }
		 */
