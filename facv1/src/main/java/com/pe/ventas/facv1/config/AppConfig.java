...
import com.pe.ventas.facv1.propiedades.globalProperties;
...
@ComponentScan(basePackages = "com.pe.ventas.facv1")
public class AppConfig extends WebMvcConfigurerAdapter {
	...
	public static DataSource getDataSource() {
		...
		dataSource.setUrl("jdbc:mysql://192.168.1.42:3306/bdventas");
